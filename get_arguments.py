...
def get_arguments():
    ...
    parser.add_argument('--commitHash', type=str, required=True,
                        help='Full or short (abbreviated) hash of the commit to modify (e.g. abc1234 or 40 chars).')
    ...
    parser.add_argument('--sameDayAt', type=str,
                        help='Keep the commit\'s date but set a specific time (24-hour format, e.g., "17:00").')
